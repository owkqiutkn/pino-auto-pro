                        ...
                        <button
                            ...
                            className={
                                segment === "featured"
                                    ...
                                    : "flex-1 md:flex-none rounded-sm border border-white/10 bg-neutral-950/60 px-2 py-1 text-center text-white shadow-sm outline-none transition-colors hover:bg-[#b91c1c] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-white md:bg-neutral-950/60 md:text-white md:shadow-none md:hover:bg-[#b91c1c] md:hover:text-white md:focus-visible:ring-[#b91c1c]"
                            }
                        >
                            {t("segments.featured")}
                        </button>
